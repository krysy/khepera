...
namespace RemoteServer
{
    public class Registers
    {
        ...
        public class Infrared
        {
            ...
            public Infrared(int backLeft, int left, int frontLeft, int front,
                int frontRight, int right, int backRight, int back,
                int groundLeft, int groundFrontLeft, int groundFrontRight, int groundRight)
            {
                BackLeft = backLeft;
                Left = left;
                FrontLeft = frontLeft;
                ...
                GroundFrontLeft = groundFrontLeft;
                GroundFrontRight = groundFrontRight;
